<template>
    <div class="main">
        <div class="main-item" v-for="(item,index) in fatherData.items" :key="index">
            <div class="feed-card">
                ...
                <div class="video-card-info-tit">
                    <router-link :to="'/playing/'+item.id+'/'+item.userId"><h3 style="color: black;">
                        {{ item.title }} </h3></router-link>
                ...
                <div class="video-card-info-bottom">
                    ...
                    <span class="userinfo"><a
                        :href="'https://www.catchstar.top?userid='+item.userId">{{ item.userName }}</a> {{
                            item.created
                        }}</span>
